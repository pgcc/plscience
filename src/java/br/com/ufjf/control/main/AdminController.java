...
public class AdminController implements Serializable {
   ...
   int idruleContex =  pegaIDRoles();
    ...
    int idruleContex =  pegaIDRoles();
        ...
        mostraGravaNewUser = true;
        password = "";
        setaPageViewAdmin = "includePage7ViewBox09_4.xhtml";
    ...
    public String atualizarUser() {
        ...
        xr.setStatus(Status);
        int role = Integer.parseInt(ruleSelecionado);
        xr.setRole_id(role);
   ...
   public String atualizarPassword(){
        try {
            ...
            User xr;
            xr = userDAO.pesquisarPorIdUser(idScientistInt);
            String senhaCripto = MetodoAuxiliar.geraMD5(password);
            xr.setPassword(senhaCripto);
            userDAO.atualizar(xr);
    ...
    public String gravaNewUser() {
     ...
     public void gravaNewUserCancel() {
         setaPageViewAdmin = "";
     }
    /*-x-x-x-x-x-x-x-x-x-x-x-x-navegação-x-x-x-x-x-x-x-x-x-x-x-x-x-**/
